...
def main(startNodeIndex, endNodeIndex):
    # 1. 获取课程章节列表
...
if __name__ == '__main__':
    startNodeIndex = int(sys.argv[1]) if len(sys.argv) > 1 else None
    endNodeIndex = int(sys.argv[2]) if len(sys.argv) > 2 else None
    main(startNodeIndex, endNodeIndex)